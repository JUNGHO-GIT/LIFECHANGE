...
for (let i = 1; i <= 100; i++) {
  ...
  const record = {
    _id: new ObjectId(),
    user_id: "123",
    work_plan_number: i + 100,
    work_plan_startDt: formatDate1(startDate),
    work_plan_endDt: formatDate1(endDate),
    ...
    work_plan_updateDt: formatDate2(updateDate),
  };
...
db.getCollection('workPlan').insertMany(demoData);