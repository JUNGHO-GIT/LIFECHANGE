// scheduleRecordRepository.ts

import mongoose from "mongoose";
import { Schedule } from "@schemas/schedule/ScheduleRecord";
...
export const list = async (
	...
	for (let d = startDate; d <= endDate; d.setDate(d.getDate() + 1)) {
		...
		finalResult.push({
			...
			schedule_exercise_record_dateEnd: exerciseItem?.exercise_record_dateEnd || "0000-00-00",
			schedule_exercise_section: exerciseItem?.exercise_section || [],

			schedule_food_record_dateType: foodItem?.food_record_dateType || "",
			schedule_food_record_dateStart: foodItem?.food_record_dateStart || "0000-00-00",
			schedule_food_record_dateEnd: foodItem?.food_record_dateEnd || "0000-00-00",
			schedule_food_section: foodItem?.food_section || [],

			schedule_money_record_dateType: moneyItem?.money_record_dateType || "",
			schedule_money_record_dateStart: moneyItem?.money_record_dateStart || "0000-00-00",
			schedule_money_record_dateEnd: moneyItem?.money_record_dateEnd || "0000-00-00",
			schedule_money_section: moneyItem?.money_section || [],

			schedule_sleep_record_dateType: sleepItem?.sleep_record_dateType || "",
			schedule_sleep_record_dateStart: sleepItem?.sleep_record_dateStart || "0000-00-00",
			schedule_sleep_record_dateEnd: sleepItem?.sleep_record_dateEnd || "0000-00-00",
