...
export const update = {
  ...
  insert: async (
    ...
    const newKcal = String (
      parseFloat(findResult.food_record_total_kcal) +
      parseFloat(OBJECT_param.food_record_total_kcal)
    );
    const newCarb = String (
      parseFloat(findResult.food_record_total_carb) +
      parseFloat(OBJECT_param.food_record_total_carb)
    );
    const newProtein = String (
      parseFloat(findResult.food_record_total_protein) +
      parseFloat(OBJECT_param.food_record_total_protein)
    );
    const newFat = String (
      parseFloat(findResult.food_record_total_fat) +
