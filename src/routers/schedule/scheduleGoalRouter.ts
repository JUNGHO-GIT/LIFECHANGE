// scheduleGoalRouter.ts

import express from "express";
import { Request, Response } from "express";
import * as service from "@services/schedule/scheduleGoalService";
// import * as middleware from "@middlewares/schedule/scheduleGoalMiddleware";
