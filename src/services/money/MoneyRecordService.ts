...
export const create = async (
  ...
  // date 변수 선언
  const existingDateType: string = OBJECT_param.money_record_dateType;
  const existingDateStart: string = OBJECT_param.money_record_dateStart;
  const existingDateEnd: string = OBJECT_param.money_record_dateEnd;
  const dateType: string = DATE_param?.dateType;
  const dateStart: string = DATE_param?.dateStart;
  const dateEnd: string = DATE_param?.dateEnd;
