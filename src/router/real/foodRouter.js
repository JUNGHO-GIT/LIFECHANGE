...
import * as service from "../../service/real/foodService.js";
export const foodRouter = express.Router();

// 0-1. dash (bar) -------------------------------------------------------------------------------->
foodRouter.get("/dashBar", async (req, res) => {
  try {
...
// 0-3. dash (line) ------------------------------------------------------------------------------->
foodRouter.get("/dashLine", async (req, res) => {
  try {
...
// 0-4. dash (avg - month) ------------------------------------------------------------------------>
foodRouter.get("/dashAvgMonth", async (req, res) => {
  try {
