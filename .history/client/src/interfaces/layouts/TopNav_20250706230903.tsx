...
import { Tabs, Tab, Checkbox, Menu, MenuItem, Select } from "@importMuis";
...
export const TopNav = () => {
  ...
  const tabsSection = () => {
    let items = [];
    if (firstStr === "calendar") {
      items = [{ label: translate("schedule"), value: "schedule" }];
    } else if (firstStr === "today") {
      items = [
        { label: translate("goal"), value: "goal" },
        { label: translate("real"), value: "real" },
      ];
    } else if (firstStr === "food") {
      items = [
        { label: translate("chart"), value: "chart" },
        { label: translate("goal"), value: "goal" },
        { label: translate("real"), value: "real" },
        { label: translate("find"), value: "find" },
      ...
      items = [{ label: translate("dashboard"), value: "dashboard" }];
    }
    ...
    return (
      <Select
        ...
        onChange={e => handleClickTobNav(e.target.value)}
        size="small"
        sx={{
          minWidth: 140,
          borderRadius: 2,
