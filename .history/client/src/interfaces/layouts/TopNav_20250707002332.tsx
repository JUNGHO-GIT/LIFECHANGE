...
export const TopNav = () => {
  ...
  const topNavNode = () => {
    ...
    const tabsSection = () => (
      ...
      >
        <Tab
          label={translate("smile")}
          value={"smile"}
          onClick={() => {
            handleClickTobNav("smile");
          }}
        />
        <Tab
          ...
          value={"scale"}
          onClick={() => {
            handleClickTobNav("scale");
          }}
        />
        <Tab
          label={translate("nutrition")}
          value={"nutrition"}
          onClick={() => {
            handleClickTobNav("nutrition");
          }}
        />
        <Tab
      ...
      >
        <MenuItem onClick={() => handleClickTobNav("smile")}>
          {translate("smile")}
        </MenuItem>
        <MenuItem onClick={() => handleClickTobNav("scale")}>
          {translate("scale")}
        </MenuItem>
        <MenuItem onClick={() => handleClickTobNav("nutrition")}>
          {translate("nutrition")}
        </MenuItem>
        <MenuItem onClick={() => handleClickTobNav("property")}>
          {translate("property")}
        </MenuItem>
        <MenuItem onClick={() => handleClickTobNav("admin")}>
          {translate("admin")}
        </MenuItem>
        <MenuItem onClick={() => handleClickTobNav("calendar")}>
          {translate("calendar")}
        </MenuItem>
        <MenuItem onClick={() => handleClickTobNav("today")}>
          {translate("today")}
        </MenuItem>
      </Menu>
      </>
