...
import { useLocation, useNavigate, useMemo, NavigateFunction } from "@exportReacts";
import type { CommonValueType, EnvType, LocalTitleType, SessionTitleType } from "@exportTypes";
...
export const useCommonValue = (): CommonValueType => {
  ...
  return {
    ...
    bgColors: [
      `#1976d2`, `#4CAF50`, `#FFC107`, `#FF5722`, `#673AB7`, `#3F51B5`, `#2196F3`, `#009688`, `#CDDC39`, `#FFEB3B`, `#9E9E9E`,
    ],
    chartColors: [
      `#0088FE`, `#00C49F`, `#FFBB28`, `#FF5733`, `#6F42C1`, `#0EA5E9`, `#22C55E`, `#D97706`, `#EF4444`, `#9333EA`,
    ],
  };
};
