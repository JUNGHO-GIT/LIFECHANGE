...
import { SlpChrtAvg } from "./SleepChartAvg";
import { SlpChrtLn } from "./SleepChartLine";
import { SlpChrtP } from "./SleepChartPie";
			...
			>
				...
				>
					<Grid size={12} className={`d-col-center p-5px`}>
						{curView === `pie` && (
							<SlpChrtP TYPE={TYPE_PIE} setTYPE={setTYPE_PIE} />
						)}
						{curView === `line` && (
							<SlpChrtLn TYPE={TYPE_LINE} setTYPE={setTYPE_LINE} />
						)}
						{curView === `avg` && (
							<SlpChrtAvg TYPE={TYPE_AVG} setTYPE={setTYPE_AVG} />
						)}
					</Grid>
				</Grid>
			</Paper>
