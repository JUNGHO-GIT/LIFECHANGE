...
export const AuthPrivacy = memo(() => {
  ...
  const authPrivacyNode = () => {
    ...
    const privacySection = () => (
      <Grid container={true} spacing={2} columns={12} className={`p-20`}>
        ...
        <Grid size={12} className={`d-col-left`}>
          ...
          <Div className={`fs-1-0rem fw-normal mb-20`}>
            ...
            <a href={`http://swww.google.com/policies/privacy/`} target={`_blank`} rel={`noopener noreferrer`}>{` Google Play Services `}</a>
            {` `}
            <a href={`http://ssupport.google.com/admob/answer/6128543?hl=en`} target={`_blank`} rel={`noopener noreferrer`}>{` AdMob `}</a>
          </Div>
          <Div className={`fs-1-0rem fw-normal`}>
