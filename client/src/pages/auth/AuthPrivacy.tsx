...
import { Div, Hr, Paper, Grid } from "@importComponents";

// -------------------------------------------------------------------------------------------------
export const AuthPrivacy = memo(() => {
  ...
  const authPrivacyNode = () => {
    ...
    const privacySection = () =>  (
			<Grid container spacing={2} columns={12} className={"p-20"}>
				...
				<Grid size={12} className={"d-col-left"}>
					...
					<Div className={"fs-1-0rem fw-normal mb-20"}>
						- Please note that the Application utilizes third-party services that have their own Privacy Policy about handling data. Below are the links to the Privacy Policy of the third-party service providers used by the Application: <a href="http://swww.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer"> Google Play Services </a> <a href="http://ssupport.google.com/admob/answer/6128543?hl=en" target="_blank" rel="noopener noreferrer"> AdMob </a>
					</Div>
					<Div className={"fs-1-0rem fw-normal"}>
    ...
    // 7-10. return
    return (
      <Paper className={"content-wrapper border-1 radius-1 shadow-1 h-min-100vh"}>
        {privacySection()}
      </Paper>
    );
  };
