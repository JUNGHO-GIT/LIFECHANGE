...
// -------------------------------------------------------------------------------------------------
declare interface MoneyRecordChartLineProps {
  TYPE?: any;
  setTYPE?: any;
  DATE?: any;
}
...
// -------------------------------------------------------------------------------------------------
export const MoneyRecordChartLine = memo((props: MoneyRecordChartLineProps) => {
    ...
    (async () => {
      ...
      try {
        ...
        const [ resWeek, resMonth ] = await Promise.all([
          axios.get(`${URL_OBJECT}/record/chart/line/week`, {
            params: params,
          }),
          axios.get(`${URL_OBJECT}/record/chart/line/month`, {
            params: params,
          }),
        ]);
        setOBJECT_WEEK(
