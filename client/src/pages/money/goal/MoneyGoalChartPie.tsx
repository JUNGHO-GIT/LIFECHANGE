...
declare interface MoneyGoalChartPieProps {
  TYPE?: any;
  setTYPE?: any;
}

// -------------------------------------------------------------------------------------------------
export const MoneyGoalChartPie = memo((props: MoneyGoalChartPieProps) => {

  // 1. common ----------------------------------------------------------------------------------
  const { URL_OBJECT, PATH, sessionId, chartThemeColors, localCurrency } = useCommonValue();
  ...
  const chartNode = () => {
    ...
    const formatValue = (value: number): string => {
      return `${insertComma(value)} ${localCurrency}`.trim();
    };
