...
export const MoneyGoalList = memo(() => {
	// 1. common ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
	const { URL_OBJECT, PATH, sessionId, localCurrency, toDetail } =
		useCommonValue();
									...
									<Grid container={true} spacing={1}>
										...
										<Grid size={10} className={`d-row-left`}>
											<Div className={`fs-0-8rem fw-600 black`}>
												{item.money_goal_dateStart?.slice(5, 10)}
											</Div>
											<Div className={`fs-0-9rem fw-500 dark ml-5px`}>
												{translate(
													getDayNotFmt(item.money_goal_dateStart).format(`ddd`),
												)}
											</Div>
											...
											<Div className={`fs-0-8rem fw-600 black`}>
												{item.money_goal_dateEnd?.slice(5, 10)}
											</Div>
											<Div className={`fs-0-9rem fw-500 dark ml-5px`}>
												{translate(
													getDayNotFmt(item.money_goal_dateEnd).format(`ddd`),
												)}
											</Div>
										</Grid>
									</Grid>
											...
											<Grid size={7}>
												<Grid container={true} spacing={1}>
													...
													<Grid size={6} className={`d-row-right`}>
														<Div
															className={`fs-0-8rem fw-600 ${item.money_goal_income_color}`}
														>
													...
													<Grid size={6} className={`d-row-right`}>
														<Div
															className={`fs-0-8rem fw-600 ${item.money_record_diff_income_color}`}
														>
															{insertComma(
																item.money_record_diff_income ?? `0`,
															)}
														</Div>
													</Grid>
													<Grid size={2} className={`d-row-center`}>
										...
										<Grid container={true} spacing={1}>
											...
											<Grid size={7}>
												<Grid container={true} spacing={1}>
													...
													<Grid size={6} className={`d-row-right`}>
														<Div
															className={`fs-0-8rem fw-600 ${item.money_goal_expense_color}`}
														>
													...
													<Grid size={6} className={`d-row-right`}>
														<Div
															className={`fs-0-8rem fw-600 ${item.money_record_diff_expense_color}`}
														>
															{insertComma(
																item.money_record_diff_expense ?? `0`,
															)}
														</Div>
													</Grid>
													<Grid size={2} className={`d-row-center`}>
