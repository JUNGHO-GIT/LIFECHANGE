...
import { AppInfo, AppInfoType } from "@exportSchemas";
import { Img, Br, Paper, Grid } from "@exportComponents";
import { TableContainer, Table, TableBody, TableRow, TableCell } from "@exportMuis";

// -------------------------------------------------------------------------------------------------
export const AdminAppInfo = memo(() => {

	// 1. common -------------------------------------------------------------------------------------
	const { URL_ADMIN, sessionId } = useCommonValue();
	const { localTimeZone, localLang } = useCommonValue();
	...
	// 2-2. useState ---------------------------------------------------------------------------------
	const [OBJECT, setOBJECT] = useState<AppInfoType>(AppInfo);
