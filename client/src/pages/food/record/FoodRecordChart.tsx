...
import { FoodRecordChartPie } from "./FoodRecordChartPie";
import { FoodRecordChartLine } from "./FoodRecordChartLine";
import { FoodRecordChartAvg } from "./FoodRecordChartAvg";
import { Select } from "@exportContainers";
import { Paper, Grid, Div, Hr } from "@exportComponents";
import { MenuItem } from "@exportMuis";

// -------------------------------------------------------------------------------------------------
declare interface FoodRecordChartProps {
  DATE?: any;
}

// -------------------------------------------------------------------------------------------------
export const FoodRecordChart = memo((props: FoodRecordChartProps) => {
  ...
  const chartNode = () => {
      ...
      <Grid container={true} spacing={0} className={`w-100p`}>
        ...
        <Grid size={12} className={`d-col-center`}>
          <Div className={`w-100p h-300px`}>
            <FoodRecordChartPie TYPE={TYPE_PIE} setTYPE={setTYPE_PIE} DATE={props?.DATE} />
          </Div>
        </Grid>
      </Grid>
    );
    ...
    const lineSection = () => (
      <Grid container={true} spacing={0} className={`w-100p`}>
        ...
        <Grid size={12} className={`d-col-center`}>
          <Div className={`w-100p h-300px`}>
            <FoodRecordChartLine TYPE={TYPE_LINE} setTYPE={setTYPE_LINE} DATE={props?.DATE} />
          </Div>
        </Grid>
      </Grid>
    );
    ...
    const avgSection = () => (
      <Grid container={true} spacing={0} className={`w-100p`}>
        ...
        <Grid size={12} className={`d-col-center`}>
          <Div className={`w-100p h-300px`}>
            <FoodRecordChartAvg TYPE={TYPE_AVG} setTYPE={setTYPE_AVG} DATE={props?.DATE} />
          </Div>
        </Grid>
      </Grid>
    );
