...
import { memo, type React, useCallback, useMemo, useRef } from "@exportReacts";

// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
export const Select = memo((props: any) => {
	// 1. common ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
	const fullWidth: boolean =
		props?.fullWidth !== undefined ? props.fullWidth : true;
	...
	const sxMemo = useMemo(
		() => ({
			...
			"& .MuiInputBase-root": {
				cursor: props?.readOnly && (props?.onClick ? `pointer` : `not-allowed`),
				backgroundColor: props?.disabled
					? `#f7f7f7`
					: props?.readOnly && (props?.onClick ? `transparent` : `#f7f7f7`),
				"&:hover": {
					backgroundColor: props?.disabled
						? `#f7f7f7`
						: props?.readOnly && (props?.onClick ? `transparent` : `#f7f7f7`),
	...
	const sltPrpsMm = useMemo(
		() => ({
			...
			input: {
				...
				readOnly: !!(props?.readOnly ?? props?.locked === `locked`),
				...
				startAdornment: props?.startadornment ? (
					typeof props?.startadornment === `string` ? (
						<div
							className={`d-center fs-0-6rem ${props?.adornmentclass ?? ``}`}
						>
			...
			inputLabel: {
				...
				shrink:
					props?.shrink === `shrink` || props?.disabled ? true : undefined,
			},
		}),
		[
			props?.slotProps,
