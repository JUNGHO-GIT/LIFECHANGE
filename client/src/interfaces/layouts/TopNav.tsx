	...
	const topNavNode = () => {
		...
		const smileSection = () => (
			<PopUp
				...
				contents={
					<Div
						className={`w-70vw h-max-70vh border-1 radius-2 shadow-0 px-10px py-20px`}
					>
						...
						<Grid container={true} spacing={0}>
							<Grid size={12} className={`d-center`}>
								<Div className={`fs-0-8rem`}>{translate(`score`)}</Div>
							</Grid>
						</Grid>
					</Div>
				}
		...
		const scaleSection = () => (
			<PopUp
				...
				contents={
					<Div
						className={`w-max-70vw h-max-70vh border-1 radius-2 shadow-0 px-10px py-20px`}
					>
						<Grid container={true} spacing={0}>
							<Grid size={12} className={`d-col-center`}>
								<Div className={`fs-1-3rem fw-600`}>{translate(`scale`)}</Div>
								<Br m={10} />
								<Div className={`fs-0-8rem fw-500 dark`}>
						...
						<Grid container={true} spacing={0} columns={20}>
							...
							<Grid size={2} className={`d-row-center`}>
								<Div className={`fs-0-6rem fw-500 dark`}>{localUnit}</Div>
							</Grid>
						</Grid>
						<Br m={10} />
						<Grid container={true} spacing={0} columns={20}>
				...
				contents={
					...
					>
						...
						<Grid container={true} spacing={0} columns={20}>
							...
							<Grid size={2} className={`d-row-center`}>
								<Div className={`fs-0-6rem fw-500 dark`}>{translate(`kc`)}</Div>
							</Grid>
						</Grid>
						<Br m={10} />
						<Grid container={true} spacing={0} columns={20}>
		...
		const tabsSection = () => {
			...
			return curTbVal ? (
				<>
					...
					>
						{dataArray?.[firstStr as keyof typeof dataArray]?.map(
							(tabName: string) => (
								<MenuItem
									key={tabName}
		...
		return (
			<Paper
				className={`layout-wrapper p-sticky top-8vh h-8vh radius-2 border-1 shadow-1 p-0px`}
			>
				<Grid container={true} spacing={0}>
