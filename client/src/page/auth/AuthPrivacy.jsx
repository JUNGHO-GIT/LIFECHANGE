...
export const AuthPrivacy = () => {
  ...
  return (
    <div style={{fontFamily: "Helvetica Neue, Helvetica, Arial, sans-serif", padding: "1em"}}>
      ...
      <p>This privacy policy applies to the LIFECHANGE app (hereby referred to as "Application") for mobile devices that was created by JUNGHO (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
      <br />
      ...
      <div style={{display: "none"}}>
        ...
        <ul>
          ...
          <li>Analytics and Improvements: Aggregated and anonymized location data helps the Service Provider to analyze user behavior, identify trends, and improve the overall performance and function ality of the Application.</li>
      ...
      <br />
      <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to Email, age, etc. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
      <br />
      ...
      <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at junghomun00@gmail.com and they will respond in a reasonable time.</p>
      <br />
      ...
      <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at junghomun00@gmail.com.</p>
      <hr />
      <p>
        This privacy policy page was generated by {" "}
        <a href="http://sapp-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer">
