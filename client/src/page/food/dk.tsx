...
export const FoodInsert = () => {
  ...
  const flowFoodInsert = async (params: any) => {
    ...
    const caloriesPer = ((calories/logicOneServing())*(Number(params))).toFixed(1);
    const carbPer = ((carb/logicOneServing())*(Number(params))).toFixed(1);
    const proteinPer = ((protein/logicOneServing())*(Number(params))).toFixed(1);
    const fatPer = ((fat/logicOneServing())*(Number(params))).toFixed(1);
