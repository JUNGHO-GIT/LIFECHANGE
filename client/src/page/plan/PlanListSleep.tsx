...
export const PlanListSleep = () => {
  ...
  const selectPlanList = () => {
    ...
    return (
      <div className="mb-3">
        <select className="form-select" id="planListDay" value={currentPath}
        onChange={(e:any) => {
          navParam(e.target.value);
        }}>
          <option value="/planListSleep">Sleep</option>
          <option value="/planListWork">Work</option>
          <option value="/planListFood">Food</option>
          <option value="/planListWork">Workout</option>
          <option value="/planListMoney">Money</option>
        </select>
      </div>
    );
  };
