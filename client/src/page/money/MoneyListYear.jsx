...
export const MoneyListYear = () => {
  ...
  const selectMoneyList = () => {
    ...
    return (
      <div className="mb-3">
        <select className="form-select" id="moneyListYear" value={currentPath} onChange={(e) => {
