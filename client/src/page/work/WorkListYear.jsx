...
export const WorkListYear = () => {
  ...
  const selectWorkList = () => {
    ...
    return (
      <div className="mb-3">
        <select className="form-select" id="workListYear" value={currentPath} onChange={(e) => {
