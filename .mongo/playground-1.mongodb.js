        ...
        user_dataCategory: {
          $function: {
            body: function(c) {
              ...
              // 원본 소스: calendar 또는 schedule
              var srcSchedule = isObj(c) && (Array.isArray(c.schedule) ? c.schedule : Array.isArray(c.calendar) ? c.calendar : []);
              ...
              // schedule: calendar_part -> schedule_record_part
